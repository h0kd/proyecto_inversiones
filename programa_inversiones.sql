...
-- Started on 2024-12-03 19:00:16
...
COPY public.boletagarantia (numero, id_banco, id_beneficiario, glosa, vencimiento, moneda, monto, fechaemision, estado, documento, tomada_por_empresa, tomada_por_rut) FROM stdin;
2	20	13	Garantía por contrato de arriendo de oficina en Santiago.	2025-08-30	CLP	8500000.00	2023-08-23	Vigente	\N	\N	\N
1	18	11	Garantía por contrato de servicios financieros	2025-12-31	CLP	3500000.00	2023-06-15	Vigente	static/uploads/boleta_garantiaTest1.pdf	\N	\N
416118	23	19	Para garantizar la seriedad de la oferta	2014-10-20	CLP	1000000.00	2014-09-12	Vigente	static/uploads/boleta_garantiaTest2.pdf	MONTAJE ELEC Y CONSTRA IND LTDA	761019139
\.
...
23	TEMP-20241203120554	BANCO SECURITY	Banco	\N	\N	\N	\N
\.
...
19	TEMP-20241203120554	COMPANIA DE PETROLEOS DE CHILE COPEC S.A	Empresa
\.
...
8908768	Cliente	2022-02-11	2024-12-22	1000000.00	static/uploads/polizaTest1.pdf
\.
...
SELECT pg_catalog.setval('public.entidad_id_entidad_seq', 23, true);
...
SELECT pg_catalog.setval('public.entidadcomercial_id_entidad_seq', 19, true);
...
-- Completed on 2024-12-03 19:00:16
