...
def formulario_add_dividendo(id_accion):
    ...
    """
    return render_template('add_dividendo.html', id_accion=id_accion)
...
def edit_dividendo(id_dividendo):
    ...
    return render_template('edit_dividendo.html', dividendo=dividendo, id_dividendo=id_dividendo, id_accion=id_accion)
